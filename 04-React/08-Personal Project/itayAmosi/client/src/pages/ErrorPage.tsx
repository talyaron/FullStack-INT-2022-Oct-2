...
<div className="bl_wrapper">
  <svg id="svg_tramp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
		...
		<path className="st38" d="M411.9 485c-1.6-3-1-6.1.1-9.2 1.5 3 .8 6.1.9 9.2-.3.6-.6.6-1 0z"/>
		<path className="st39" d="M415.9 499c-1.8-2.9-.6-6.1-.8-9.1.2-.4.5-.8 1-1 1.8 3.2.6 6.7.9 10.1-.4.6-.7.6-1.1 0z"/>
		<path className="st40" d="M416 496.3c-1.6-3-2.1-22.4-1-25.5 1.3 2.6.9 5.5.9 8.3-.2.4.5 17 .1 17.2z"/>
		<path d="M413.1 497c1.8 2.6.6 5.3 1 9.1-3.1-3.5-1.7-6.5-2-9.1.3-.6.7-.6 1 0z" fill="#ced2d4"/>
		<path className="st39" d="M409.1 486c1.8 2.9.6 6.1.9 9.1-.3.6-.7.6-1 0-1.7-2.5-.7-5.4-.9-8.1.2-.5.5-.8 1-1z"/>
		<path d="M405 487c-1.6-2.1-.9-4.2-.5-7.4 2.1 2.7 1.4 4.7 1.5 6.5-.3.4-.6.7-1 .9z" fill="#ccd0d2"/>
		<path className="st43" d="M413.1 497h-1c0-4-.1-8-.1-12h1c0 4 0 8 .1 12z"/>
		<path className="st44" d="M405 487l1-1c0 3.6.1 7.3.1 10.9.4 1-.1 1.2-1 1-.1-3.6-.1-7.2-.1-10.9z"/>
		...
		<path className="st49" d="M423 482c.2 3.9-.3 19.4-1.2 15.7 0-1.9.2-18.6.2-21.3 1.5 2.3.8 4 1 5.6z"/>
		...
		<path className="st38" d="M358.1 502c.3-3.4-.9-6.8.9-10 .3-.6.7-.6 1 0-.3 3.3.9 6.8-.9 10-.4.6-.7.6-1 0z"/>
		<path className="st40" d="M369.1 490c.1-3.1-.5-6.2.9-10.6 1.4 4.4 1.6 7.4.1 10.6-.4.6-.7.6-1 0z"/>
		<path d="M352.9 485.9v6.3c-2.5-2.3-2.4-4.7-1-7.2.5.2.8.5 1 .9z" fill="#ced1d4"/>
		<path className="st43" d="M369.1 490h1v9.9c-.5 1.5-1 2.9-1.2-.1 0-.6 0-1.3.1-1.9 0-2.6 0-5.2.1-7.9z"/>
		<path className="st55" d="M362.1 488h1v10.9c-.3.5.2 1.7-1.1 1 0-3.9 0-7.9.1-11.9z"/>
		<path d="M355.1 491h.9v9.8h-.9V491z" fill="#bac2c6"/>
		<path className="st43" d="M359.9 492h-1c.1-3.3.1-6.6.2-10h.9c0 3.3 0 6.6-.1 10z"/>
		<path className="st49" d="M366.9 489h-1v-8.8h1v8.8z"/>
		<path className="st44" d="M352.9 485.9c-.3-.3-.7-.6-1-1v-7.8h1v8.8z"/>
		<path className="st55" d="M356.9 480h-1c.2-2.3-.4-4.6.5-7.2 1 2.6.4 4.9.5 7.2z"/>
		<path d="M373.9 488.9l-1-1v-3.7h1v4.7z" fill="#b9c1c4"/>
		<path className="st49" d="M358.1 502h1v3.7h-1V502zM365 498c1.5 1.5 1 3.2 0 4.8V498z"/>
		<symbol id="eyes">
		...
		<text transform="matrix(1 0 0 1 354 346)" className="text_forgiveness">Will</text>
		<text transform="matrix(1 0 0 1 351 372)">
			<tspan x="0" y="0" className="text_forgiveness">code site</tspan>
			<tspan x="0" y="31" className="text_forgiveness">for food</tspan>
		</text>
	</svg>
        <button className="btn_home"><Link to="/">Go HOME</Link></button>
</div>
  );
}